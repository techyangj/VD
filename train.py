...
# Train
# print("class_map:",class_map, "map_reverse:", map_reverse, "num_iters:", num_iters)

# for images, labels in train_data:
#     for i in range(images.size(0)):  # 遍历每个批次中的图像
#         print(f"Image {i} size in this batch: {images[i].shape}")
#
# for images, labels in test_data:
#     for i in range(images.size(0)):  # 遍历每个批次中的图像
#         print(f"Image {i} size in this batch: {images[i].shape}")
# for images, labels in train_data:
#     print(f"Image batch size: {images.shape}")  # 输出每个批次中图像的尺寸
