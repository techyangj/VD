...
def load__data():
    ...
    for client in clients:
        print(os.path.join(root_dir, f'{client}', 'clean_train'))
        train_data.append(list(datasets.ImageFolder(
            root= root_dir + "/" + f'{client}' + "/clean_train",
    ...
    train_data_poi = []
    for client in clients:
        print(os.path.join(root_dir, f'{client}', 'poison_train'))
        train_data_poi.append(list(datasets.ImageFolder(
            root= root_dir + "/" + f'{client}' + "/poison_train",
            # os.path.join(root_dir, f'{client}', 'poison_train'),
            transform=data_transforms
        )))
